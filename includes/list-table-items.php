...
class EasyCustomJsAndCss_List_Table_Items extends WP_List_Table {
	function __construct() {
		parent::__construct(array(
			'singular'=> EASYJC_PLUGIN_NAME . '_item',
			'plural' => EASYJC_PLUGIN_NAME . '_items',
			'ajax' => false
		));
	}
	...
	function get_columns() {
		$columns = array(
			...
			'active'    => __('Active', EASYJC_PLUGIN_NAME),
			'type'      => __('Type', EASYJC_PLUGIN_NAME),
